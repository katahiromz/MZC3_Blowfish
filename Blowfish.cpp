////////////////////////////////////////////////////////////////////////////
// Blowfish.cpp -- Blowfish encrypter and decrypter
...
void MBlowfish::_SetPassword0(const char *passwd, size_t len)
{
    size_t i, j;
...
{
    static const unsigned long pa_init[bf_pa_size] =
    {
    ...
    assert(sizeof(m_pa) == sizeof(pa_init));
    assert(sizeof(m_sb) == sizeof(sb_init));
    memcpy(m_pa, pa_init, sizeof(m_pa));
    memcpy(m_sb, sb_init, sizeof(m_sb));
}
